...
- Scope: seven small extension modules configured in `src/repositories/pi-goal-xx/mutation-check.yml`.
...
- Normalized report: `reports/pi-goal-xx/typescript/mutation.json`; 37 survivors classified as coverage gaps because command runner has no per-test coverage mapping; no weak-test entries claimed.
